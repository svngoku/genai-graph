...
STREAMLIT_ENTRY_POINT="genai_graph/main/streamlit.py"
MODAL_ENTRY_POINT="genai_graph/main/modal_app.py"
APP=genai-graph
IMAGE_VERSION=0.2a
...
# Assumes project structure: parent/genai-tk and parent/genai-graph
